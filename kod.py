...
with col2:
    st.markdown("""<div style="font-size:16px"><span style="text-decoration: underline;">Średnia zauważalność (prawdopodobieństwo, że reklama będzie zauważona)</span></div>""", unsafe_allow_html=True)
    obrazek = "zauw.jpg"
    st.image(obrazek, caption='',  width = 690)

st.markdown("""<div style="font-size:16px"><span style="text-decoration: underline;">Średnia zauważalność według tematyki</span></div>""", unsafe_allow_html=True)
